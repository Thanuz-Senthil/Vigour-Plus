...
class _ProfileState extends State<Profile> {
  ...
  setDataToTextField(data){
    ...
    return
      ...
      children: [
        ...
        SizedBox(height: 20,),
        Text('NIC Number:',style: TextStyle(
            color: Colors.black87,

            fontSize: 18,
            fontWeight: FontWeight.w400),),
        TextFormField(
          controller: _NICController = TextEditingController(text: data['NIC']),//age
        ),
        SizedBox(height: 20,),
        Text('Address:',style: TextStyle(
            ...
            fontWeight: FontWeight.w400),),
        TextFormField(
          controller: _addressController = TextEditingController(text: data['Address']),//age
        ),
        SizedBox(height: 20,),
  ...
  updateData(){
    CollectionReference _collectionRef = FirebaseFirestore.instance.collection("patient");//users-form-data
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      SingleChildScrollView(
       ...
       child:StreamBuilder(
          stream: FirebaseFirestore.instance.collection("patient").doc(FirebaseAuth.instance.currentUser!.uid)/*email*/.snapshots(),
